"use client"
import { createspez } from "@/app/actions/admin/group/specializations/create";
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <form className="bg-gray-200 shadow-md rounded px-8 pt-6 pb-8 w-full">
                    ...
                    <input type='text' placeholder={id} value={id} onChange={(e)=> setId(e.target.value)} className="shadow appearance-none border rounded w-full py-2 px-1 text-black" />
                    <label className="block text-black text-sm font-bold mb-1">
